...
//                        ImageView sendFromMail = (ImageView) view.findViewById(R.id.send_from_mail);
        ...
        btnStop.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                FileHelper.close();
                if (m_vFragmentDataMeasure.getThread().isAlive()){
                    m_vFragmentDataMeasure.setStopFlag(true);
                    m_vSecondFragmentDataMeasure.setStopFlag(true);
                    m_vThirdFragmentDataMeasure.setStopFlag(true);
                }
            }
        });
